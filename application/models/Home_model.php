...
#------------------------------------------------    
    public function home_data($page = 'home') {       
        $result = $this->db->select('t1.news_id,t1.post_date,t1.time_stamp,t1.page,t1.stitle,t1.title,t1.image,t1.news,t1.reference,t1.ref_date,t1.post_by,t1.reporter,t1.status,t1.videos,t3.id,t3.name,t3.photo')
