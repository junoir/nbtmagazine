        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6">
                <fieldset><legend>Optional</legend>
                    <table>
                        <tr>
                            <th>Ref.</th><th>:</th><td><?php echo form_dropdown('reference', $reference_info, $reference, 'class="form-control"'); ?></td>
                        ...
                        <tr>
                            <th>Videos</th><th>:</th><td><input type="text" name="videos" class="form-control" /></td>
