        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6 form-inline">
                <fieldset><legend><?php echo display('optional');?></legend>
                    <table>
                        <tr>
                            <th><?php echo display('ref');?></th><th>:</th><td><?php echo $row['name']; ?></td>
                            <th> <?php echo display('date');?></th><th>:</th><td><input type="text" name="ref_date" value="<?php echo $row['post_date']?>" class="form-control datepicker" /></td>
                        </tr>
                        <tr>
                            <th><?php echo display('video_url');?></th><th>:</th><td><input type="text" name="videos" value="<?php echo $row['videos']; ?>"  class="form-control"/></td>
                            <th><?php echo display('reporter');?></th><th>:</th><td><input type="text" name="reporter" value="<?php echo $row['reference']; ?>"  class="form-control"/></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
